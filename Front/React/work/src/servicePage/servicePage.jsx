      ...
      <Container className="aboutCompanyContainer" fluid>
        ...
        <Container className="aboutCompanyExplane">
          ...
          <p className="mt-4">
            ...
            از12سال فعالیت پرسنل خود در صنايع مخابرات و شبکه و سیستم های هوشمند و
            امنیتی به همت متخصصین خود در صنعت مخابرات و فناوری اطلاعات در
            سال 1390 رسما تاسیس گرديده است و عضو پارک علم و فناوری و شرکت های
