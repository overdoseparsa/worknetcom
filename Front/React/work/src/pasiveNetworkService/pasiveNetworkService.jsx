...
import "bootstrap";
import "./pasiveNetworkService.css";
import PctiveNetworkServicesAccording from "./pasiveNetworkServiceAccording/pasiveNetworkServiceAccording";
export default class pasiveNetworkService extends Component {
  render() {
    return (
      <>
