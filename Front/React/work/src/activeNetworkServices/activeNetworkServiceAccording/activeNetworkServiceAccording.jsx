          ...
          <Accordion.Item className="accordingItem" eventKey="2">
            <Accordion.Header
              className="accordingHeader
                        "
            >
              <h6>نصب و راه اندازی آنتی ویروس بر روی سرورو کالینت</h6>
            </Accordion.Header>
            <Accordion.Body className="accordingBody">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
          ...
          <Accordion.Item className="accordingItem" eventKey="3">
            <Accordion.Header
              className="accordingHeader
                        "
            >
              <h6>نصب و راه اندازی سیستم های تلفن تحت شبکه</h6>
            </Accordion.Header>
            <Accordion.Body className="accordingBody">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
          ...
          <Accordion.Item className="accordingItem" eventKey="4">
            <Accordion.Header
              className="accordingHeader
                        "
            >
              <h6>ایجاد بسترVoIPبا استفاده از تجهیزات سیسکو</h6>
            </Accordion.Header>
            <Accordion.Body className="accordingBody">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
          ...
          <Accordion.Item className="accordingItem" eventKey="6">
            <Accordion.Header
              className="accordingHeader
                        "
            >
              <h6> کلیه خدمات اجراییLANوWANسیسکو</h6>
            </Accordion.Header>
            <Accordion.Body className="accordingBody">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
          ...
          <Accordion.Item className="accordingItem" eventKey="7">
            <Accordion.Header
              className="accordingHeader
                        "
            >
              <h6> روتینگ و سوئیجینگ و فایروال سیسکو</h6>
            </Accordion.Header>
            <Accordion.Body className="accordingBody">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
