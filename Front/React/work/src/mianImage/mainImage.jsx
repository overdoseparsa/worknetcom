            ...
            <>
                <Container className='mainContainer' fluid>
                    <Container className='mainText' fluid>
                        ...
                        <button type='button' className='button1 btn btn-outline-danger'>اطلاعات بیشتر</button>
                        <button type='button' className='button2 btn btn-outline-danger'>تماس باما</button>
                    </Container>
                </Container>
            </>
        )
